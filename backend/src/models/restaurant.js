...
const restaurantSchema = new Schema({
    ...
    rating: Number,
    cusines: [
        // We will add cuisines category and then cuisines-> food
        {
            category: {
                type: 'String',
                lowercase: true
    ...
    // cusineCategories: [ //it will create redendancy or duplication with cusines
    //     {
    //         name: String
    //     }
    // ],
    ...
    reviews: [ // it will be given by user 
        {
            userId: {
...
//to iterate the cusines and add all the categories in cusineCategory
